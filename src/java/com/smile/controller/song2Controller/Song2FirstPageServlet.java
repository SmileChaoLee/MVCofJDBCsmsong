 ...
 * @author chaolee
 */
@WebServlet(name = "Song2FirstPageServlet", urlPatterns = {"/song2Controller/Song2FirstPageServlet"})
public class Song2FirstPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Song2FirstPageServlet->doGet() ....");
