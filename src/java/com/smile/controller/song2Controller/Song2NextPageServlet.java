 ...
 * @author chaolee
 */
@WebServlet(name = "Song2NextPageServlet", urlPatterns = {"/song2Controller/Song2NextPageServlet"})
public class Song2NextPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Song2NextPageServlet->doGet() ....");
        ...
        int lastPage = song2Table.getTotalPageOfQuery(song2Attr.getQueryCondition());
